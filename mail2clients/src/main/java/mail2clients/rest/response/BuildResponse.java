package mail2clients.rest.response;
...
public class BuildResponse {
    ...
    public static ResponseEntity<?> okStatus(String url, Object data) {
        return new ResponseEntity<>(new Response(HttpStatus.OK, url, "Mailing service request response.", data), new HttpHeaders(), HttpStatus.OK);
    }
